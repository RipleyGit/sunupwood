...
public interface ProductApi {
    ...
    @ApiOperation(value = "获取商品列表", nickname = "getProducts", notes = "", response = ProductArray.class, authorizations = {
        @Authorization(value = "token")
    }, tags={ "Product", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "商品列表", response = ProductArray.class) })
    ...
    @ApiOperation(value = "获取分类下的所有商品", nickname = "queryListByItem", notes = "", response = ProductArray.class, authorizations = {
        @Authorization(value = "token")
    }, tags={ "Product", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "商品列表", response = ProductArray.class) })
    ...
    @ApiOperation(value = "获取分类，标签下的所有商品", nickname = "queryListByItemLabel", notes = "", response = ProductArray.class, authorizations = {
        @Authorization(value = "token")
    }, tags={ "Product", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "商品列表", response = ProductArray.class) })
    ...
    @ApiOperation(value = "获取标签下的所有商品", nickname = "queryListByLabel", notes = "", response = ProductArray.class, authorizations = {
        @Authorization(value = "token")
    }, tags={ "Product", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "商品列表", response = ProductArray.class) })
